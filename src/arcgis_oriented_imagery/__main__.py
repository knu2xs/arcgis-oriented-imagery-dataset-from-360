...
def example_function(in_path: Union[str, Path]) -> pd.DataFrame:
    ...
    ``` python
    from arcgis_oriented_imagery import example_function
...
class ExampleObject(object):
    ...
    def example_static_function(in_path: Union[str, Path]) -> pd.DataFrame:
        ...
        ``` python
        from arcgis_oriented_imagery import ExampleObject
    ...
    def example_class_method(cls) -> "ExampleObject":
        ...
        ``` python
        from from arcgis_oriented_imagery import ExampleObject
