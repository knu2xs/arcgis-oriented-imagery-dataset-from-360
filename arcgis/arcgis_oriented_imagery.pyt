...
if importlib.util.find_spec("arcgis_oriented_imagery") is None:
    src_dir = find_pkg_source("arcgis_oriented_imagery")
...
class Toolbox:
    def __init__(self):
        ...
        self.label = "arcgis-oriented-imagery-dataset-from-360"
        self.alias = "arcgis_oriented_imagery"
...
class CreateDataDirectory:
    ...
    def execute(self, parameters, messages):
        ...
        arcgis_oriented_imagery.utils.configure_logging("INFO")
        ...
        arcgis_oriented_imagery.utils.build_data_resources(dir_data)
